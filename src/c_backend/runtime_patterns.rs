...
pub(super) fn emit_runtime_pattern_helpers(
    ...
    out.push_str("}\n");
    out.push('\n');
    out.push_str("static TnVal *tn_pattern_local_keys = NULL;\n");
    out.push_str("static size_t *tn_pattern_local_keys_len = NULL;\n");
    out.push('\n');
    out.push_str("static int tn_pattern_local_key_contains(TnVal key) {\n");
    out.push_str("  if (tn_pattern_local_keys == NULL || tn_pattern_local_keys_len == NULL) {\n");
    out.push_str("    return 0;\n");
    out.push_str("  }\n");
    out.push_str("  for (size_t i = 0; i < *tn_pattern_local_keys_len; i += 1) {\n");
    out.push_str("    if (tn_pattern_local_keys[i] == key) {\n");
    out.push_str("      return 1;\n");
    out.push_str("    }\n");
    out.push_str("  }\n");
    out.push_str("  return 0;\n");
    out.push_str("}\n");
    out.push('\n');
    out.push_str("static void tn_pattern_local_key_push(TnVal key) {\n");
    out.push_str("  if (tn_pattern_local_keys == NULL || tn_pattern_local_keys_len == NULL) {\n");
    out.push_str("    return;\n");
    out.push_str("  }\n");
    out.push_str("  if (*tn_pattern_local_keys_len >= TN_MAX_BINDINGS) {\n");
    out.push_str("    fprintf(stderr, \"error: native runtime binding capacity exceeded\\n\");\n");
    out.push_str("    exit(1);\n");
    out.push_str("  }\n");
    out.push_str("  tn_pattern_local_keys[*tn_pattern_local_keys_len] = key;\n");
    out.push_str("  *tn_pattern_local_keys_len += 1;\n");
    out.push_str("}\n");
    out.push('\n');
    ...
    out.push_str("  TnVal local_keys[TN_MAX_BINDINGS];\n");
    out.push_str("  size_t local_keys_len = 0;\n");
    out.push_str("  TnVal *saved_local_keys = tn_pattern_local_keys;\n");
    out.push_str("  size_t *saved_local_keys_len = tn_pattern_local_keys_len;\n");
    out.push_str("  tn_binding_snapshot(snapshot, &snapshot_len);\n");
    out.push_str("  tn_pattern_local_keys = local_keys;\n");
    out.push_str("  tn_pattern_local_keys_len = &local_keys_len;\n");
    out.push('\n');
    out.push_str("  if (tn_pattern_match_internal(value, pattern_hash)) {\n");
    out.push_str("    tn_pattern_local_keys = saved_local_keys;\n");
    out.push_str("    tn_pattern_local_keys_len = saved_local_keys_len;\n");
    out.push_str("    return 1;\n");
    out.push_str("  }\n");
    out.push('\n');
    out.push_str("  tn_pattern_local_keys = saved_local_keys;\n");
