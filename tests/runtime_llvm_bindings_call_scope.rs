...
#[test]
fn compiled_runtime_isolates_caller_pattern_bindings_from_named_function_calls() {
    let fixture_root = common::unique_fixture_root("runtime-llvm-bindings-call-scope");
    ...
    fs::write(
        ...
        "defmodule Demo do\n  def run() do\n    case sample() do\n      [43, 43, 43, 10 | rest] ->\n        take(rest)\n\n      _ ->\n        {:error, \"missing opening fence\"}\n    end\n  end\n\n  defp take([10, 43, 43, 43, 10 | body]) do\n    {:ok, body}\n  end\n\n  defp take([byte | rest]) do\n    take(rest)\n  end\n\n  defp take([]) do\n    {:error, \"missing closing fence\"}\n  end\n\n  defp sample() do\n    [43, 43, 43, 10, 116, 10, 43, 43, 43, 10, 35]\n  end\nend\n",
    )
